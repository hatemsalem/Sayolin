...
import com.zobonapp.gallery.utils.DemoGlideHelper;
import com.zobonapp.gallery.utils.RecyclerAdapterHelper;

import java.util.List;

public class PhotoListAdapter2 extends DefaultEndlessRecyclerAdapter<PhotoListAdapter2.ViewHolder> {

    private List<Photo> photos;
    private boolean hasMore = true;
    private final OnPhotoListener listener;

    public PhotoListAdapter2(OnPhotoListener listener) {
        super();
