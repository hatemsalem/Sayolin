...
public class OfferCategoryAdapter extends GenericPagerAdapter<CategoryHolder,Category>
{
    ...
    public static Bundle newArguments(int type,String searchKey)
    {
        ...
        arguments.putString(ARG_ADAPTER_CLASS,OfferCategoryAdapter.class.getName());
        return arguments;
    }
    @Override
    ...
    {
        return ZobonApp.getContext().getDataManager().findOffersCategoriesForPage(type,page * PAGE_SIZE, PAGE_SIZE,searchQuery);
    }
